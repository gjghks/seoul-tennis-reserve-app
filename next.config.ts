        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              `connect-src 'self' https://*.supabase.co https://pagead2.googlesyndication.com https://*.adtrafficquality.google https://www.googletagmanager.com https://www.google-analytics.com https://openAPI.seoul.go.kr:8088 https://apihub.kma.go.kr https://*.kakao.com https://*.kakaocdn.net https://*.daumcdn.net wss://*.supabase.co${process.env.NODE_ENV === 'development' ? ' http://*.kakao.com http://*.kakaocdn.net http://*.daumcdn.net ws://localhost:*' : ''}`,

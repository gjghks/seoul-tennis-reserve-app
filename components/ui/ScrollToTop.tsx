  ...
  return (
    <button
      ...
      className={`
        ...
        ${themeClass(
          'bg-black text-white border-2 border-black dark:border-[#f1f3f8] rounded-[5px] shadow-[3px_3px_0px_0px_#000] dark:shadow-[3px_3px_0px_0px_#f1f3f8] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none',

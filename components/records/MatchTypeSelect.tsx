        ...
        return (
          <button
            ...
            className={isSelected
              ...
              : themeClass(
                  'px-4 py-2 border-2 border-black rounded-[5px] font-bold bg-white text-black hover:bg-gray-50',
                  'px-4 py-2 rounded-lg font-medium bg-gray-100 text-gray-700 hover:bg-gray-200'
                )
            }
          >
            {option.label}

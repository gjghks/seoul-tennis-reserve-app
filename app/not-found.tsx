...
export default function NotFound() {
  ...
  return (
    <div className="container py-16">
      <div className={`max-w-md mx-auto text-center ${themeClass('bg-[#a8e6cf] border-[3px] border-black rounded-[10px] shadow-[6px_6px_0px_0px_#000] p-8', 'bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8')}`}>
        ...
        <div className={`text-8xl font-black mb-4 ${themeClass('text-black', 'text-gray-200 dark:text-slate-700')}`}>
          404
        </div>

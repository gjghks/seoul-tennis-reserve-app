        ...
        <div className={`space-y-8 ${isNeoBrutalism ? 'text-black/80' : 'text-gray-600'}`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <a 
                ...
                className={`text-lg font-semibold hover:underline ${
                  isNeoBrutalism ? 'text-black' : 'text-green-600'
                }`}
              >
                gjghks84@gmail.com
              </a>
          ...
          <section>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className={isNeoBrutalism ? 'text-black' : 'text-gray-900'}>
                    서비스 개선 제안
                  </strong>
              ...
              <li className="flex items-start gap-3">
                <span className={`w-8 h-8 flex items-center justify-center rounded-full shrink-0 ${
                  isNeoBrutalism 
                    ? 'bg-purple-300 border-2 border-black' 
                    : 'bg-purple-100'
                }`}>
                  🤝
                </span>
          ...
          <section className={`p-4 rounded-lg ${
            ...
            <ul className={`text-sm space-y-1 ${
              isNeoBrutalism ? 'text-black/70' : 'text-gray-500'
            }`}>
